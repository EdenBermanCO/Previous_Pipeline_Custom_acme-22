This [Code Ocean](https://codeocean.com) Pipeline will allow you to run and reproduce the results of [Previous Pipeline Custom - acme-2.22.0 - Original](https://acmecorp-edge.codeocean.com/capsule/8059344/tree) on your local machine<sup>1</sup>. Follow the instructions below, or consult [our knowledge base](https://docs.codeocean.com/user-guide/compute-capsule-basics/managing-capsules/exporting-capsules-to-your-local-machine) for more information. Don't hesitate to reach out to [Support](mailto:support@codeocean.com) if you have any questions.
...
* [SDK-Result](https://acmecorp-edge.codeocean.com/data-assets/6fac8006-86d0-45a8-87fe-63db2510e962) should be downloaded to `data/Reads`
